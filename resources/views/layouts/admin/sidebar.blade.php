<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.products.index')) active @endif" 
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.subcategories.index')) active @endif" 
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.coupons.index')) active @endif" 
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.reviews.index')) active @endif" 
