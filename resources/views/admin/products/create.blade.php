                            ...
                            <form action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name_fr" placeholder="Name FR*"
                                            value="{{old('name_fr')}}" class="form-control @error('name_fr') is-invalid @enderror">
                                        @error('name_fr')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="subcategory_id" class="form-select @error('subcategory_id') is-invalid @enderror">
                                            @foreach ($subcategories as $subcategory)
                                                <option 
                                                    @if($subcategory->id == old('subcategory_id')) selected @endif
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="selling_price" placeholder="Price*"
                                            value="{{old('selling_price')}}" class="form-control @error('selling_price') is-invalid @enderror">
                                        @error('selling_price')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="old_price" placeholder="Old Price"
                                            value="{{old('old_price')}}" class="form-control @error('old_price') is-invalid @enderror">
                                        @error('old_price')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="desc_en" class="form-control summernote @error('desc_en') is-invalid @enderror" cols="30" rows="10" placeholder="Description EN*">{{old('desc_en')}}</textarea>
                                        @error('desc_en')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="desc_fr" class="form-control summernote @error('desc_fr') is-invalid @enderror" cols="30" rows="10" placeholder="Description FR*">{{old('desc_fr')}}</textarea>
                                        @error('desc_fr')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
