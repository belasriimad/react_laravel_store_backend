                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name_en" placeholder="Name EN*"
                                            value="{{$subcategory->name_en, old('name_en')}}" class="form-control @error('name_en') is-invalid @enderror">
                                        @error('name_en')
                                    ...
                                    <div class="col-md-6">
                                        <label for="name_en" class="my-2">Name FR*</label>
                                        <input type="text" name="name_fr" placeholder="Name FR*" 
                                            value="{{$subcategory->name_fr, old('name_fr')}}" class="form-control @error('name_fr') is-invalid @enderror">
                                        @error('name_fr')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
