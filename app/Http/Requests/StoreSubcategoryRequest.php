...
class StoreSubcategoryRequest extends FormRequest
{
    ...
    {
        return [
            'name_en' => 'required|max:255|unique:subcategories',
            'name_fr' => 'required|max:255|unique:subcategories',
    ...
    public function messages()
    {
        return[
            ...
            'name_fr.max' => 'The field subcategory name in french must not be greater 
                than :max characters .',
            'name_en.unique' => 'You have already added this subcategory.',
            'name_fr.unique' => 'You have already added this subcategory.',
