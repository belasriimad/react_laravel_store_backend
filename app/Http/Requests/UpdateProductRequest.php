...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            //
            'name_en' => 'required|max:255|unique:products,id,'.$this->id,
            'name_fr' => 'required|max:255|unique:products,id,'.$this->id,
            ...
            'tag_en' => 'max:255',
            'tag_fr' => 'max:255',
            'desc_fr' => 'required|not_in:<p><br></p>',
            'desc_en' => 'required|not_in:<p><br></p>',
            'product_thumbnail' => 'image|mimes:png,jpg,jpeg|max:2048',
    ...
    public function messages()
    {
        return[
            ...
            'desc_en.not_in' => 'The field product description in english is required.',
            'desc_fr.not_in' => 'The field product description in french is required.',
            'desc_en.max' => 'The field product description in english must not be greater 
            than :max characters .',
            'desc_fr.max' => 'The field product description in french must not be greater 
            than :max characters .',
            'qty.required' => 'The field product quantity is required.',
            'category_id.required' => 'The field product category is required.',
            'subcategory_id.required' => 'The field product sucategory is required.',
